...
<header> <h1 style="color:#5e1692;"><center> Find Your Order </h1></center> <header>
<center>
<form class="demo">
<select id="color" name="color"  class=option3 onchange="showUser(this.value,this.name)">
           ...
           <?php
             ...
             $select=$con->query("select color from seller group by color");
 ...
 <select id="fabric" name="fabric"  class=option3 onchange="showUser(this.value,this.name,color.value)">
           ...
           <?php
             ...
             $select=$con->query("select fabric from seller group by fabric");
			 
             while($row=$select->fetch_assoc())
             {
			    echo '<option value="'.$row['fabric'].'">'.$row['fabric'].'</option>';
             }
 ...
 <select id="dia" name="dia"  class=option3 onchange="showUser(this.value,this.name,color.value,fabric.value)">
           ...
           <?php
             ...
             $select=$con->query("select dia from seller group by dia");
